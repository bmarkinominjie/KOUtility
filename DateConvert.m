...
/**
 BirthdayData *birthDayData = [[BirthdayData alloc]init];
 [birthDayData setMyBirthdayData:2017 m:6 d:5 h:19 t:kGongLi r:NO];

 NSLog(@"公历:%lu年-%lu月-%lu日-%lu时",birthDayData.year,birthDayData.month,birthDayData.day,birthDayData.hour);
 DateConvert *dateConvert = [[DateConvert alloc]init];
 BirthdayData *nongLiDate = [dateConvert Convert2NongLi:birthDayData];

 NSLog(@"农历:%lu年-%lu月-%lu日-%lu时",nongLiDate.year,nongLiDate.month,nongLiDate.day,nongLiDate.hour);
